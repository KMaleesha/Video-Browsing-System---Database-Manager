			...
			<div class="banner">
				<div class="container">
					...
					<div class="login-area">
						<!-- heading -->
						<h1 > WELCOME TO DATABASE ADMINISTRATION </h1><br>
						<h3>Please Enter Video Code and Name</h3>
					 <form action="videologin" method="post">
							<div class="form-group">
								<input type="text" name="vid"  class="form-control" id="exampleInputUser1" placeholder="Video code">
							</div>
							<div class="form-group">
								<input type="text" name="vname" class="form-control" id="exampleInputPassword1" placeholder="Video Name">
							</div>
							...
							<button type="submit"   name="submit" class="btn btn-default">Give Access</button>
						</form>
					</div>
				</div>
			</div>
