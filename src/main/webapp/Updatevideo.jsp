...
<div class="wrapper">
		...
		<center><h2>--UPDATE DETAILS--</h2></center><br><br><br>
...
<table align="center">
	...
	<tr>
		<td>Video code&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="vcode" style="width:400px" value = "<%=videocode%>"></td>
	</tr>
	<tr>
		<td>Video Name&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="vname" style="width:400px" value = "<%=videoname%>"></td>
	</tr>
	<tr>
		<td>Description&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="des" style="width:400px" value = "<%=description%>"></td>
	</tr>
	<tr>
		<td>Date&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="date" style="width:400px" value = "<%=date%>"></td>
	</tr>
	<tr>	
		<td>Path&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="pth" style="width:400px" value = "<%=path%>"></td>
	</tr>
	<tr>
		<td>Thumb nail&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="thbn" style="width:400px" value = "<%=thumbnail%>"></td>
	</tr>
</table><br><br>
		<center><input type = "submit" name ="submit" value =" Update Video "></center>
