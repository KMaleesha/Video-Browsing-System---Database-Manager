...
<title>Add new video into DB</title>
...
<br>
			...
			<center><h2>--INSERT NEW VIDEO--</h2></center><br>
						<form action="insert" method="post">
							<table align="center">
	<tr>
		<td>Video code&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="vcode" style="width:400px"></td><br>
	</tr>
	<tr>
		<td>Video Name&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="vname" style="width:400px"></td>
	</tr>
	<tr>
		<td>Description&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="des" style="width:400px"></td>
	</tr>
	<tr>
		<td>Date&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="text" name ="date" style="width:400px"></td>
	</tr>
	<tr>	
		<td>Path&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<tr>
		<td>Thumb nail&nbsp;&nbsp;&nbsp;&nbsp;</td> 
		<td> <input type="text" name ="thbn" style="width:400px"></td>
	</tr>	
	</table><br><br>
	<center><input type = "submit" name ="submit" value ="Insert Video"></center>
	</form><br>
